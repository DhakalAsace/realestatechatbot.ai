...
- Public chat rejects oversized raw request bodies before JSON parsing, then rejects spam, prompt-extraction, unsafe markup, control characters, and link floods before sessions, usage, AI, messages, or leads are created.
